...
QWEN_PATH = "../qwen_output/qwen_multimodal_results.csv"
...
invalid_df.to_csv("../qwen_output/qwen_multimodal_1shot_invalid.csv", index=False)
...
df.to_csv("../qwen_output/qwen_evaluation_result_multimodal.csv", index=False)
