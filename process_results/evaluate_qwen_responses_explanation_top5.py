...
# === File paths ===
PRED_PATH = "../prediction_analysis_fsft_top5.csv"
QWEN_PATH = "../qwen_output/qwen_top5_explanations_fsft.csv"  # updated path
OUTPUT_CSV = "../post_processed_csv/qwen_evaluation_result_explanation_top5_fsft.csv"
INVALID_CSV = "../error_logs/qwen_invalid_responses_top5_fsft.csv"
