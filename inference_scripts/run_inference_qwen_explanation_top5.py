...
OUTPUT_CSV = "../qwen_output/qwen_top5_explanations.csv"
ERROR_FILE = "../error_logs/qwen_error_log_top5_explanation.txt"
...
# Rename column to avoid KeyError
...
df["pred4_sci"] = df.get("pred4_sci", df["pred4_name"])
df["pred5_sci"] = df.get("pred5_sci", df["pred5_name"])
