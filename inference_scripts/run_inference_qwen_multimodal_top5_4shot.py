...
PREGNERATED_REF_DIR = "../dataset/semi-aves/pregenerated_references_4shot"
CSV_PATH = "../prediction_analysis_top5.csv"
METADATA_JSON = "../dataset/semi-aves/semi-aves_metrics-LAION400M-updated.json"
OUTPUT_CSV = "../qwen_output/qwen_multimodal_top5_4shot_results.csv"
SKIPPED_LOG = "../error_logs/qwen_multimodal_top5_4shot_skipped.txt"
TIMEOUT_SEC = 60
...
def build_multimodal_prompt(query_image, candidates):
    messages = [
        {"type": "text", "text":
         ...
         "Step 2: Compare it to each of the 5 candidate species. Each candidate includes the species name and a stitched image showing four different individuals of that species.\n"
