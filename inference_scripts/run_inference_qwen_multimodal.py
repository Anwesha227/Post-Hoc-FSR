...
OUTPUT_CSV = "../qwen_output/qwen_multimodal_results.csv"
SKIPPED_LOG = "../error_logs/qwen_multimodal_skipped.txt"
TIMEOUT_SEC = 60
...
def build_multimodal_prompt(query_image, candidates):
    """
    candidates: list of tuples [(sci_name, [img1_base64, img2_base64]), ...]
    """
    messages = [
        {"type": "text", "text":
         ...
         "Step 2: Compare it to each of the 3 candidate species. Each candidate includes the species name and two example images.\n"
