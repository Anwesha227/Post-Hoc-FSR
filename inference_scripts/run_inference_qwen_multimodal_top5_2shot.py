...
OUTPUT_CSV = "../qwen_output/qwen_multimodal_top5_2shot_results.csv"
SKIPPED_LOG = "../error_logs/qwen_multimodal_top5_2shot_skipped.txt"
TIMEOUT_SEC = 60
...
def build_multimodal_prompt(query_image, candidates):
    messages = [
        {"type": "text", "text":
         ...
         "Step 2: Compare it to each of the 5 candidate species. Each candidate includes the species name and a stitched image showing two different individuals of that species.\n"
